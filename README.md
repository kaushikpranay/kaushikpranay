...
Currently building:
Adaptive AI systems with memory, retries,
semantic caching, and multi-model routing on AWS.
```
...
- Reduce hallucinations before adding features
- Retrieval quality matters more than prompt hacks
- Every AI system needs fallback logic
- Observability is not optional
- Shipping beats overengineering
```
...
## Self-Improving RAG Infrastructure

Production-grade customer support system that improves over time using human feedback loops and adaptive retrieval.
...
```txt
Python • TensorFlow • CNN • OpenCV • Keras
```

---

# live_system_status.json
...
<a href="https://linkedin.com/in/kaushikprny">
...
<a href="https://rag-system.ddns.net/">
  <img src="https://img.shields.io/badge/Live_Project-38BDF8?style=for-the-badge&logo=vercel&logoColor=black"/>
</a>
